...
## Description
The Web3Method class extends from the Web3Context. It is the main class that interacts with the BEATOZ, and provides various methods for different functionalities, like checking the health of the chain, getting info about blocks, transactions etc.

## Methods
Below is a list of methods provided by the Web3Method class:


- **health**: Checks the operational health and readiness of the BEATOZ, ensuring all components are functioning as expected.

- **status**: Retrieves a comprehensive status report of the BEATOZ, including current operational metrics and state.
...
- **dumpConsensusState**: Provides a snapshot or dump of the current consensus state of the BEATOZ.
