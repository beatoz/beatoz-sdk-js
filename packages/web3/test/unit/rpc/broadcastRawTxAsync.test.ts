...
import { AccountResponse, BroadcastTxAsyncResponse } from '@beatoz/web3-types';
...
describe('broadcastTxAsync check ', () => {
    ...
    it('should call web3 with testWebsocketWeb3Instance.broadcastTxAsync() method success return', async () => {
        ...
        const broadcastTxAsyncResponse: BroadcastTxAsyncResponse =
            await testWebsocketWeb3Instance.beatoz.broadcastRawTxAsync(rawTransaction);
