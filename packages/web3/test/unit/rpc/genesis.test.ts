...
import { GenesisResponse } from '@beatoz/web3-types';
...
describe('genesis check ', () => {
    ...
    it('should call web3 with testWebsocketWeb3Instance.genesis method success return', async () => {
        const testWebsocketGenesisResponse: GenesisResponse =
            await testWebsocketWeb3Instance.beatoz.genesis();
