...
export default class WebsocketProvider<API extends Web3APISpec = BeatozExecutionAPI> {
    ...
    >(payload: Web3APIPayload<API, Method>): Promise<JsonRpcResponseWithResult<ResponseType>> {
