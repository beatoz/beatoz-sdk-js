...
import { Web3RequestManager } from '@beatoz/web3-core';
import {
...
export async function health(requestManager: Web3RequestManager): Promise<HealthResponse> {
...
export async function status(requestManager: Web3RequestManager): Promise<StatusResponse> {
...
export async function netInfo(requestManager: Web3RequestManager): Promise<NetInfoResponse> {
...
export async function genesis(requestManager: Web3RequestManager): Promise<GenesisResponse> {
...
export async function abciInfo(requestManager: Web3RequestManager): Promise<AbciInfoResponse> {
...
export async function broadcastEvidence(requestManager: Web3RequestManager, evidence: string) {
...
export async function rule(requestManager: Web3RequestManager): Promise<RuleResponse> {
...
export function subscribeNewBlock(requestManager: Web3RequestManager): Stream<SubscriptionEvent> {
